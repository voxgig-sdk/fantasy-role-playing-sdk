...
const testSeed = `map[string]any{"entity": map[string]any{"entity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "roll": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
