...
// instead of `sdk.NewFantasyRolePlayingSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *FantasyRolePlayingSDK  { return NewFantasyRolePlayingSDK(nil) }
func Test() *FantasyRolePlayingSDK { return TestSDK(nil, nil) }
