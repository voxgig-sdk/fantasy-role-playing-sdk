...
type FantasyRolePlayingSDK struct {
	Mode     string
...
func (sdk *FantasyRolePlayingSDK) OptionsMap() map[string]any {
...
func (sdk *FantasyRolePlayingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FantasyRolePlayingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FantasyRolePlayingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FantasyRolePlayingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FantasyRolePlayingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FantasyRolePlayingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FantasyRolePlayingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FantasyRolePlayingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FantasyRolePlayingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FantasyRolePlayingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FantasyRolePlayingSDK {
	...
	sdk := NewFantasyRolePlayingSDK(sdkopts)
	sdk.Mode = "test"
