# FantasyRolePlaying Golang SDK Reference

Complete API reference for the FantasyRolePlaying Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FantasyRolePlayingSDK`
...
#### `Entity(data map[string]any) FantasyRolePlayingEntity`

Create a new `Entity` entity instance. Pass `nil` for no initial data.

#### `Roll(data map[string]any) FantasyRolePlayingEntity`
