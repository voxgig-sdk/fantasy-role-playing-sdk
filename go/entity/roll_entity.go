...
type RollEntity struct {
	name    string
	client  *core.FantasyRolePlayingSDK
...
func NewRollEntity(client *core.FantasyRolePlayingSDK, entopts map[string]any) *RollEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RollEntity) GetName() string { return e.name }
...
func (e *RollEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RollEntity) Deleted() bool {
	return e.deleted
}


func (e *RollEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRollEntity(e.client, opts)
}

func (e *RollEntity) Data(args ...any) any {
...
func (e *RollEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Roll; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RollEntity) DataTyped(data ...Roll) Roll {
	if len(data) > 0 {
		return typedFrom[Roll](e.Data(asMap(data[0])))
	}
	return typedFrom[Roll](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Roll (all fields
// optional at the wire level).
func (e *RollEntity) MatchTyped(match ...Roll) Roll {
	if len(match) > 0 {
		return typedFrom[Roll](e.Match(asMap(match[0])))
	}
	return typedFrom[Roll](e.Match())
}
...
func (e *RollEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RollEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RollLoadMatch and returns an Roll. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RollEntity) LoadTyped(reqmatch RollLoadMatch, ctrl map[string]any) (Roll, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Roll{}, err
	}
	return typedFrom[Roll](res), nil
}




func (e *RollEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RollListMatch and returns []Roll. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RollEntity) ListTyped(reqmatch RollListMatch, ctrl map[string]any) ([]Roll, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Roll](res), nil
}



func (e *RollEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RollEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RollEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RollEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
