# FantasyRolePlaying SDK Entity entity
...
class EntityEntity
  ...
  #
  # @param reqmatch [EntityListMatch, Hash, nil] match filter (any subset of
  #   Entity fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Entity>, Array] the matching Entity items; raises FantasyRolePlayingError on failure
