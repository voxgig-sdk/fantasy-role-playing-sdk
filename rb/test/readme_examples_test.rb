...
#      offline in seeded test mode (FantasyRolePlayingSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FantasyRolePlaying_sdk.rb")
  SDK_CLASS = "FantasyRolePlayingSDK"
  ...
  SDK_BASE = "FantasyRolePlaying_sdk"
