...
type Args struct {
	Entity string         `json:"entity" jsonschema:"entity | roll"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FantasyRolePlayingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fantasy-role-playing_list",
		Description: "List records from FantasyRolePlaying. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fantasy-role-playing_load",
		Description: "Load a single record from FantasyRolePlaying. " +
...
func runOp(client *sdk.FantasyRolePlayingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FantasyRolePlayingSDK, name string) (sdk.FantasyRolePlayingEntity, error) {
	switch strings.ToLower(name) {
	case "entity":
		return client.Entity(nil), nil
	case "roll":
		return client.Roll(nil), nil
