// Command FantasyRolePlaying-mcp is an MCP server exposing the FantasyRolePlaying
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FantasyRolePlaying_list  — list records of an entity
//	FantasyRolePlaying_load  — load a single record of an entity
//
