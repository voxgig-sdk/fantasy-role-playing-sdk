# FantasyRolePlaying SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FantasyRolePlayingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FantasyRolePlayingSDK(...) and FantasyRolePlayingSDK.test(...) become
#      FantasyRolePlayingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fantasyroleplaying_sdk"
_SDK_CLASS = "FantasyRolePlayingSDK"
