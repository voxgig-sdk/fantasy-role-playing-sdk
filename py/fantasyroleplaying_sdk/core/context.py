...
from fantasyroleplaying_sdk.core.helpers import get_ctx_prop, to_map
...
class FantasyRolePlayingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FantasyRolePlayingControl()
        ...
        if isinstance(sp, FantasyRolePlayingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FantasyRolePlayingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FantasyRolePlayingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FantasyRolePlayingOperation({})
    ...
    def make_error(self, code, msg):
        return FantasyRolePlayingError(code, msg, self)
