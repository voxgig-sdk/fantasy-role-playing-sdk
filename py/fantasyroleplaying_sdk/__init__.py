...
from fantasyroleplaying_sdk.utility import register

# Load features
from fantasyroleplaying_sdk.feature.base_feature import FantasyRolePlayingBaseFeature
from fantasyroleplaying_sdk.features import _has_feature, _make_feature
...
class FantasyRolePlayingSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FantasyRolePlayingUtility()
    ...
    def get_utility(self):
        return FantasyRolePlayingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FantasyRolePlayingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Entity(self, data=None) -> "EntityEntity":
        ...
        from fantasyroleplaying_sdk.entity.entity_entity import EntityEntity
        return EntityEntity(self, data)


    def Roll(self, data=None) -> "RollEntity":
        """Entity factory: client.Roll().list() / client.Roll().load({"id": ...})."""
        from fantasyroleplaying_sdk.entity.roll_entity import RollEntity
