# FantasyRolePlaying Python SDK Reference

Complete API reference for the FantasyRolePlaying Python SDK.
...
#### `FantasyRolePlayingSDK.test(testopts=None, sdkopts=None)`
...
Create a new `RollEntity` instance. Pass `None` for no initial data.
...
Create a new `RollEntity` instance with the same options.
