...
// FantasyRolePlaying SDK pipeline test
//
...
{
    private static function utility(): FantasyRolePlayingUtility
    {
        return new FantasyRolePlayingUtility();
    }
    ...
    private static function ctx(array $over = []): FantasyRolePlayingContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FantasyRolePlayingContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FantasyRolePlayingOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FantasyRolePlayingError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FantasyRolePlayingOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FantasyRolePlayingMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FantasyRolePlayingOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FantasyRolePlayingMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FantasyRolePlayingOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FantasyRolePlayingMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FantasyRolePlayingSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FantasyRolePlayingMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FantasyRolePlayingResponse([]),
            'result' => new FantasyRolePlayingResult([]),
        ]);
        [, $err] = FantasyRolePlayingMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FantasyRolePlayingSpec([]),
            'response' => null,
            'result' => new FantasyRolePlayingResult([]),
        ]);
        [, $err] = FantasyRolePlayingMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FantasyRolePlayingSpec(['step' => 's']),
            'response' => new FantasyRolePlayingResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FantasyRolePlayingResult([]),
        ]);
        [, $err] = FantasyRolePlayingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FantasyRolePlayingSpec(['step' => 's']),
            'response' => new FantasyRolePlayingResponse(self::resp(200, ['v' => 1])),
            'result' => new FantasyRolePlayingResult([]),
        ]);
        [, $err] = FantasyRolePlayingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FantasyRolePlayingSpec(['step' => 's']),
            'response' => new FantasyRolePlayingResponse(self::resp(200, ['v' => 2])),
            'result' => new FantasyRolePlayingResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FantasyRolePlayingMakeResponse::call($ctx);
    ...
    {
        $preset = new FantasyRolePlayingResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FantasyRolePlayingSpec([]),
            'response' => new FantasyRolePlayingResponse([]),
            'result' => new FantasyRolePlayingResult([]),
        ...
        [$got, $err] = FantasyRolePlayingMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FantasyRolePlayingResult([])]);
        [, $err] = FantasyRolePlayingMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FantasyRolePlayingSpec([]), 'result' => null]);
        [, $err] = FantasyRolePlayingMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FantasyRolePlayingSpec(['step' => 's']),
            'result' => new FantasyRolePlayingResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FantasyRolePlayingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FantasyRolePlayingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FantasyRolePlayingSpec(['step' => 's']),
            'result' => new FantasyRolePlayingResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FantasyRolePlayingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FantasyRolePlayingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FantasyRolePlayingResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FantasyRolePlayingSpec([]),
            'result' => new FantasyRolePlayingResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FantasyRolePlayingMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FantasyRolePlayingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FantasyRolePlayingError('boom', 'boom');
        $utility->fetcher = function (FantasyRolePlayingContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FantasyRolePlayingSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FantasyRolePlayingMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FantasyRolePlayingContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FantasyRolePlayingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FantasyRolePlayingResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FantasyRolePlayingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FantasyRolePlayingContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FantasyRolePlayingSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FantasyRolePlayingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FantasyRolePlayingResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FantasyRolePlayingSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FantasyRolePlayingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FantasyRolePlayingMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FantasyRolePlayingMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FantasyRolePlayingResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FantasyRolePlayingDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FantasyRolePlayingResult(['ok' => false])]);
        $this->expectException(FantasyRolePlayingError::class);
        FantasyRolePlayingDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FantasyRolePlayingResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FantasyRolePlayingMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FantasyRolePlayingMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FantasyRolePlayingBaseFeature();
        $b = new FantasyRolePlayingBaseFeature();
        FantasyRolePlayingFeatureAdd::call($ctx, $a);
        FantasyRolePlayingFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FantasyRolePlayingBaseFeature
    {
        $f = new FantasyRolePlayingBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FantasyRolePlayingFeatureAdd::call($ctx, self::named_feature('a'));
        FantasyRolePlayingFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        FantasyRolePlayingFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        FantasyRolePlayingFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        FantasyRolePlayingFeatureAdd::call($ctx, $replace);
        ...
        FantasyRolePlayingFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FantasyRolePlayingContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FantasyRolePlayingSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FantasyRolePlayingPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FantasyRolePlayingPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FantasyRolePlayingResponse(['headers' => null]),
            'result' => new FantasyRolePlayingResult([]),
        ]);
        FantasyRolePlayingResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FantasyRolePlayingResultBody::call($ctx);
