...
// FantasyRolePlaying SDK netsim feature
...
class FantasyRolePlayingNetsimFeature extends FantasyRolePlayingBaseFeature
{
    ...
    private function _simulate(FantasyRolePlayingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FantasyRolePlayingContext $ctx, array $applied): void
    {
        $client = $this->client;
