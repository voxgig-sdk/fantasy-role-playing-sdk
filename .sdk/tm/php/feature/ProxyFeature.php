...
// FantasyRolePlaying SDK proxy feature
...
class FantasyRolePlayingProxyFeature extends FantasyRolePlayingBaseFeature
{
    ...
    public function init(FantasyRolePlayingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FantasyRolePlayingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
