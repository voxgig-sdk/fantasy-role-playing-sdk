...
// FantasyRolePlaying SDK utility: graphql
//
...
class FantasyRolePlayingGraphql
{
    ...
    // equivalent.
    public static function body(FantasyRolePlayingContext $ctx): mixed
    {
    ...
    public static function errors(FantasyRolePlayingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
