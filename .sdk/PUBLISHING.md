...
|---|---|---|
| `ts/` | @voxgig-sdk/fantasy-role-playing-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fantasy-role-playing-sdk \
      --repository voxgig-sdk/fantasy-role-playing-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fantasy-role-playing-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fantasy-role-playing-sdk --id=<id>` removes it.
