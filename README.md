...
This is an unofficial SDK for the Fantasy Role Playing public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/fantasy-role-playing` | `npm install @voxgig-sdk/fantasy-role-playing` |
| Python | `voxgig-sdk-fantasy-role-playing` | `pip install voxgig-sdk-fantasy-role-playing` |
| PHP | `voxgig-sdk/fantasy-role-playing` | `composer require voxgig-sdk/fantasy-role-playing` |
| Golang | `github.com/voxgig-sdk/fantasy-role-playing-sdk/go` | `go get github.com/voxgig-sdk/fantasy-role-playing-sdk/go` |
| Ruby | `voxgig-sdk-fantasy-role-playing` | `gem install voxgig-sdk-fantasy-role-playing` |
| Lua | `voxgig-sdk-fantasy-role-playing` | `luarocks install voxgig-sdk-fantasy-role-playing` |
