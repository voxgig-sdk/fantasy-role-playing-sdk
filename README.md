...
Set API allows users to query and generate entities within a fantasy role-playing world.

Learn more about Fantasy Role Playing API at [set.world](https://set.world).
...
This SDK exposes the API as a small set of **semantic entities** — Entity and Roll — that you
...
| --- | --- | --- |
| **Entity** | The Entity entity (list). | `/advantages` |
| **Roll** | The Roll entity (list, load). | `/roll/character` |
