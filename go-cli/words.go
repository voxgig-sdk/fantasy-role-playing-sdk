...
func registerSDKWords(r *eng.Registry, client *sdk.FantasyRolePlayingSDK) {
...
func runOp(client *sdk.FantasyRolePlayingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
