...
class FantasyRolePlayingSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = FantasyRolePlayingHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = FantasyRolePlayingHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!FantasyRolePlayingFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, FantasyRolePlayingFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return FantasyRolePlayingUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = FantasyRolePlayingHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = FantasyRolePlayingHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = FantasyRolePlayingHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new FantasyRolePlayingError($op . "_allow",
                "FantasyRolePlayingSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = FantasyRolePlayingHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new FantasyRolePlayingError("graphql_error",
                "FantasyRolePlayingSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Roll($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_roll === null) {
                $this->_roll = new RollEntity($this, null);
            }
            return $this->_roll;
        }
        return new RollEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new FantasyRolePlayingSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
