...
// FantasyRolePlaying SDK clienttrack feature
...
class FantasyRolePlayingClienttrackFeature extends FantasyRolePlayingBaseFeature
{
    ...
    public function PostConstruct(FantasyRolePlayingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FantasyRolePlaying-SDK';
