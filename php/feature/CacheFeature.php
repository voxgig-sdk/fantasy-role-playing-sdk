...
// FantasyRolePlaying SDK cache feature
...
class FantasyRolePlayingCacheFeature extends FantasyRolePlayingBaseFeature
{
    ...
    private function _through(FantasyRolePlayingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
