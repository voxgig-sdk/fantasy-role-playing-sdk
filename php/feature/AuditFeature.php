...
// FantasyRolePlaying SDK audit feature
...
class FantasyRolePlayingAuditFeature extends FantasyRolePlayingBaseFeature
{
    ...
    private function _emit(FantasyRolePlayingContext $ctx, string $outcome): void
    {
