...
// FantasyRolePlaying SDK timeout feature
...
class FantasyRolePlayingTimeoutFeature extends FantasyRolePlayingBaseFeature
{
    ...
    private function _with_timeout(FantasyRolePlayingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FantasyRolePlayingContext $_ctx, float $ms): void
    {
        $client = $this->client;
