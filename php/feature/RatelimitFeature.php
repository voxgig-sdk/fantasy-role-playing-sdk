...
// FantasyRolePlaying SDK ratelimit feature
...
class FantasyRolePlayingRatelimitFeature extends FantasyRolePlayingBaseFeature
{
    ...
    private function _acquire(FantasyRolePlayingContext $ctx): void
    {
    ...
    private function _track(FantasyRolePlayingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
