...
// FantasyRolePlaying SDK rbac feature
...
class FantasyRolePlayingRbacFeature extends FantasyRolePlayingBaseFeature
{
    ...
    private function _required(FantasyRolePlayingContext $ctx): ?string
    {
    ...
    private function _reject(FantasyRolePlayingContext $ctx, string $required): void
    {
    ...
    private function _track(FantasyRolePlayingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
