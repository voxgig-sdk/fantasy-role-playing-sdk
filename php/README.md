# FantasyRolePlaying PHP SDK



The PHP SDK for the FantasyRolePlaying API — an entity-oriented client using PHP conventions.
...
The main class (`fantasyroleplaying_sdk.php`) exports the SDK class
