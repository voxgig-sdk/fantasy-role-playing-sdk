...
// FantasyRolePlaying SDK utility type

class FantasyRolePlayingUtility
{
    ...
    public static function copy(FantasyRolePlayingUtility $src): FantasyRolePlayingUtility
    {
        $u = new FantasyRolePlayingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
