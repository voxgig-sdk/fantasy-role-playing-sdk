...
class EntityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FANTASYROLEPLAYING_TEST_ENTITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function entity_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FANTASYROLEPLAYING_TEST_ENTITY_ENTID");
