...
class EntityEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = FantasyRolePlayingSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FANTASY_ROLE_PLAYING_TEST_ENTITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $entity_ref01_data = null;
        if (count($entity_ref01_data_raw) > 0) {
...
function entity_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FANTASY_ROLE_PLAYING_TEST_ENTITY_ENTID");
