...
// FantasyRolePlaying SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FantasyRolePlayingSDK::test)
...
{
    private const SDK_CLASS = 'FantasyRolePlayingSDK';
    ...
    private const SDK_BASE = 'fantasyroleplaying_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../fantasyroleplaying_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
