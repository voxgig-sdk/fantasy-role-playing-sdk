...
// FantasyRolePlaying SDK utility: result_basic

class FantasyRolePlayingResultBasic
{
    public static function call(FantasyRolePlayingContext $ctx): ?FantasyRolePlayingResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof FantasyRolePlayingError) ? $result->err->msg : (string)$result->err;
