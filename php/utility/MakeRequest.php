...
// FantasyRolePlaying SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FantasyRolePlayingMakeRequest
{
    public static function call(FantasyRolePlayingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FantasyRolePlayingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FantasyRolePlayingResponse($fetched);
        } else {
