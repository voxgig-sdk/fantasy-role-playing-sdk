...
// FantasyRolePlaying SDK utility: make_options

class FantasyRolePlayingMakeOptions
{
    ...
    public static function call(FantasyRolePlayingContext $ctx): array
    {
        ...
        //
        // `FantasyRolePlayingSchema::optspec()` is built from the model:
        ...
        $optspec = FantasyRolePlayingSchema::optspec();
