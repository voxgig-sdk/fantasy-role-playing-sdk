...
// FantasyRolePlaying SDK utility: fetcher

class FantasyRolePlayingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FantasyRolePlayingSDK/1.0)';
    ...
    public static function call(FantasyRolePlayingContext $ctx, string $fullurl, array $fetchdef): array
    {
